  ...
  <div>
    <div class="mdl-grid">
      ...
      <div class="mdl-cell mdl-cell-6-col mdl-cell--4-col-phone">
        <div v-for="picture in getCats()" :key="picture.url" class="image-card" @click="displayDetails(picture['.key'])">
    ...
    <router-link class="take-picture-button mdl-button mbl-js-button mdl-button--fab mdl-button--colored" to="/camera">
